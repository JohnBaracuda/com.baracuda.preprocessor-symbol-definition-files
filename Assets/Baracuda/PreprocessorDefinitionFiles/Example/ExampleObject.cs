...
namespace Baracuda.PreprocessorDefinitionFiles.Example
{
...
#pragma warning restore
    ...
    [UnityEditor.CustomEditor(typeof(ExampleObject))]
    internal class ExampleObjectInspector : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                ((ExampleObject)target).InvokeExample();
            }
