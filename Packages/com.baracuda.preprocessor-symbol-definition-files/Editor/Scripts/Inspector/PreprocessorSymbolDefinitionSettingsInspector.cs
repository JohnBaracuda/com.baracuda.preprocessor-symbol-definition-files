...
namespace Baracuda.PreprocessorDefinitionFiles.Scripts.Inspector
{
    ...
    public class PreprocessorSymbolDefinitionSettingsInspector : Editor
    {
        ...
        private SerializedProperty _sdsFileProperty;
        ...
        {
            _securedSymbolProperty = serializedObject.FindProperty(PreprocessorSymbolDefinitionSettings.NameElevatedSymbols);
            _sdsFileProperty = serializedObject.FindProperty(PreprocessorSymbolDefinitionSettings.NameSdsFiles);
            ...
            _sdsFileList = new ReorderableList(serializedObject, _sdsFileProperty, false, true, false, false);
        ...
        private void DrawFiles(Rect rect, int index, bool isActive, bool isFocused)
        {
            var file = (PreprocessorSymbolDefinitionFile)
                _sdsFileList.serializedProperty.GetArrayElementAtIndex(index).objectReferenceValue;
